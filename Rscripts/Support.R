...
# ggsave("Figures/Round12_Double_AllDiv_Support.png", width = 15, height = 10, bg = "white")
...
# ggsave("Figures/Round12_Quadruple_AllDiv_Support.png", width = 12, height = 4, bg = "white")
...
# ggsave("Figures/Round12_Single_Support.png", width = 10, height = 4, bg = "white")
...
# ggsave("Figures/Round12_Single_splitDiv_Support.png", width = 8, height = 20, bg = "white")
...
doubleplot_Support <- annotate_figure(doubleplot_Support,
                                       top = text_grob("Support needs",
                                                       face = "bold", size = 14))
doubleplot_Support
# ggsave("Figures/Round12_Double_SplitDiv_Support.png", width = 10, height = 15, bg = "white")
...
# ggsave("Figures/Round12_Quadruple_SplitDiv_Support.png", width = 10, height = 13, bg = "white")
