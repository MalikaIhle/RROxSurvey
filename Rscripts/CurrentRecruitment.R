...
title_plot_Current_allstaff_regrouped <- paste ("Researchers (N=",sum(as.numeric(sst_allstaffdata$Total[sst_allstaffdata$Question == "CurrentRecruitment"])), ")" , sep="")
...
title_plot_Current_allstaff <- paste ("Researchers (N=",sum(as.numeric(sst_allstaffdata[sst_allstaffdata$Question == "CurrentRecruitment", Plotted_Div ])), ")" , sep="")
...
title_plot_Current_alldata <- paste ("PGR students and all researchers combined (N=",sum(as.numeric(sst_data[sst_data$Question == "CurrentRecruitment", Plotted_Div ])),")" , sep="")
