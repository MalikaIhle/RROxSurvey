...
# ggsave("Figures/Round12_Double_AllDiv_CurrentRecruitment.png", width = 15, height = 10, bg = "white")
...
#ggsave("Figures/Round12_Quadruple_AllDiv_CurrentRecruitment.png", width = 15, height = 10, bg = "white")
