...
sst_data[c(1:9, 12,13),c(1,7,6,8,5,9)] %>% flextable() %>% 
    set_caption(caption = "Number of survey participants per Division and per question",
                style = "Table Caption", 
                autonum = run_autonum(seq_id = "tab", bkm = "tabSSdivQ"))
```
...
xtab_OtherTraining %>% flextable() %>% 
    set_caption(caption = "Other training requested",
                style = "Table Caption", 
                autonum = run_autonum(seq_id = "tab", bkm = "tbltraining"))
```
<!--# FIXME -->
...
xtab_OtherSupport %>% flextable() %>% 
    set_caption(caption = "Other support requested",
                style = "Table Caption", 
                autonum = run_autonum(seq_id = "tab", bkm = "tblsupport"))
```
