...
Barriers to **Data sharing** were ethical concerns, the lack of ownership of the data, the lack of support (including financial support) to prepare data for sharing, the lack of metadata standards, the fact that original effort of collecting primary data isn't recognised and data are not protected from scooping, and the fact that repositories aren't user-friendly.
...
In terms of bigger incentives, I think it would be very interesting and useful to run focus groups with academics to discuss possible change in recruitment criteria, especially with regards to ORPs in the context of the broader complex system.
