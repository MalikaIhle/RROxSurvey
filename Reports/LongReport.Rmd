...
source(here::here("Rscripts","FormatPGRdata.R"))
...
TO_REMOVE_JUST FOR TESTING_This is a reference to flextable \@ref(tab:tabSS).
...
<br> When looking at the same data split per Divisions, it appears respondents from the Humanities and the SSD had overall less awareness of the open research practices proposed than respondents from the MSD and MPLS (on average **`r unaware_HumSSD`%** vs **`r unaware_MSDMPLS`%**, respectively).\
