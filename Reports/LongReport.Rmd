...
a <- cbind( " " = c("Number of PGR respondents", "PGR students census 2021", "Representativeness in %", "Number of dropouts", "Dropouts in %"), sst[c(1, 11, 12, 13, 14),2:7])
rownames(a) <- NULL
